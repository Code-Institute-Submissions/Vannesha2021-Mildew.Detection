...
def page_summary_body():
    ...
    st.info(
        ...
        f"* Mildew is a fungal disease that is affecting the cherry"
        "plantations at Farmy & Foods.\n"
    ...
    st.write(
        ...
        f"[Project README file](https://github.com/Vannesha2021/Mildew.Detection/blob/main/README.md).")

    st.success(
        f"The project has 2 business requirements:\n"
        f"* 1 - The client is interested in conducting a study to"
        "visually differentiate"
        f"a cherry leaf that is healthy from the one that contains"
        "powdery mildew.\n"
        f"* 2 - The client is interested in predicting if a cherry tree"
